...
def drawFigure(x,y1,y2,y3):
    ...
    plt.xlabel('gamma')
    plt.ylabel('accuracy')
    plt.title('the accuracy of gamma selection')
    plt.savefig('/home/amax/Documents/robot/Lee/zhao/implicit-opinion/svm/result/accuracy_svm_gamma.jpg')
    plt.show()

def saveToTxt(x,train,dev,test):
    f=open('/home/amax/Documents/robot/Lee/zhao/implicit-opinion/svm/result/accuracy_svm_gamma.txt','w',encoding='utf-8')
...
print('正在训练模型')
epoch=0
for c in range(46,47):
    c=c/10.
    for gamma in range(1,201):
        gamma=gamma/500.
        kernel='rbf'
